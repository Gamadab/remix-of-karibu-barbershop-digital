    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center bg-gold text-gold-foreground px-5 py-2.5 text-sm font-bold uppercase tracking-widest hover:opacity-90 transition-opacity"
          >
            Go home
          </Link>
        </div>
